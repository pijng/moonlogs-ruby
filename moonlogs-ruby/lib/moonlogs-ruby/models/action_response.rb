...
module MoonlogsRuby
  class ActionResponse
    ...
    def list_invalid_properties
      ...
      if @schema_ids.nil?
        invalid_properties.push('invalid value for "schema_ids", schema_ids cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @schema_ids.nil?
    ...
    def hash
      [id, name, pattern, method, conditions, schema_name, schema_ids, disabled].hash
    end
