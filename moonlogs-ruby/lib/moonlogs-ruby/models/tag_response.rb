...
module MoonlogsRuby
  class TagResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'view_order')
        self.view_order = attributes[:'view_order']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @view_order.nil?
        invalid_properties.push('invalid value for "view_order", view_order cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @view_order.nil?
      true
    end
