...
module MoonlogsRuby
  class DefaultApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [SchemaSearch] :body 
    # @return [InlineResponse200]
    def api_schemas_search_post(opts = {})
      data, _status_code, _headers = api_schemas_search_post_with_http_info(opts)
      data
    end
    ...
    # @option opts [SchemaSearch] :body 
    # @return [Array<(InlineResponse200, Integer, Hash)>] InlineResponse200 data, response status code and response headers
    def api_schemas_search_post_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DefaultApi.api_schemas_search_post ...'
      end
      # resource path
      local_var_path = '/api/schemas/search'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DefaultApi#api_schemas_search_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # @param [Hash] opts the optional parameters
